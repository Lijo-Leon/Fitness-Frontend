...
function Dashboard() {
    ...
    const handleDownloadPDF = async (itemId) => {
        try {
            const item = fitnessList.find((entry) => entry.id === itemId);
            if (!item) return;
            ...
            pdf.text('Fitness & Health Log', pageWidth / 2, 16, { align: 'center' });

            pdf.setFontSize(16);
            pdf.text(`Date: ${item.date}`, 15, 35);

            pdf.setFontSize(14);
            pdf.text('Nutrition & Workout Details', 15, 50);
            ...
            const data = [
                ...
                ['Food Items', item.fooditems],
                ['Calories', `${item.calories} kcal`],
                ['Workout', item.workout],
                ['Duration', `${item.duration} mins`],
                ['Calories Burned', `${item.burned} kcal`],
            ];
            ...
            pdf.text('Generated By FITNEX', pageWidth / 2, 285, { align: 'center' });

            pdf.save(`fitness-log-${item.date}.pdf`);
        } catch (error) {
                        ...
                        <div className="main w-full px-4 md:px-20 mt-30 md:mt-10 pb-10 min-h-screen">
                            <div className="box w-full pb-8 bg-black flex flex-col items-center rounded-2xl gap-8 text-amber-50 tracking-wide text-lg font-semibold px-4 md:px-10 pt-5">
                                ...
                                {fitnessList.length > 0 ? (
                                    <div id='result' className="details w-full h-auto mt-6 flex flex-col gap-5">
